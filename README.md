# Template Minecraft Configuration

<sup>Forked from [Template Asset Repository](https://github.com/EsotericTemplates/template-asset-repository)</sup>

[![Project Status: Maintained](./.assets/images/badges/status/maintained.svg)](./) [![Repository Size](https://img.shields.io/github/repo-size/EsotericTemplates/template-minecraft-configuration?style=for-the-badge&logo=github&label=Repository%20size)](./)
...
template assets templates template-project asset template-repository template-generic-repo minecraft configuration minecraft-configuration
